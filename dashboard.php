...
// Cek apakah user mengakses halaman dashboard.php tanpa parameter

if (basename($_SERVER['PHP_SELF']) === 'dashboard.php' && empty($_GET['page'])) {
    // Redirect ke halaman laporan_kegiatan dengan parameter page
    header("Location: http://localhost/tipe_a/dashboard.php?page=transaksi");
    exit();
}
?>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        ?>
                            <li class="sidebar-item <?php if (strpos($_SERVER['REQUEST_URI'], 'dashboard.php?page=transaksi') !== false) echo "active"; ?>">
                                <a href="dashboard.php?page=transaksi" class='sidebar-link'>
                                    <i class="bi bi-clipboard2"></i>
                                    <span>Transaksi Pembelian</span>
                                </a>
                            </li>

                            <li class="sidebar-item <?php if (strpos($_SERVER['REQUEST_URI'], 'dashboard.php?page=laporan') !== false) echo "active"; ?>">
                        ...
                        ?>
                            ...
                            <li class="sidebar-item <?php
                                                    if (strpos($_SERVER['REQUEST_URI'], 'dashboard.php?page=saldo') !== false)
                                                        echo "active";
                                                    ?> ">
                                <a href="dashboard.php?page=saldo" class='sidebar-link'>
